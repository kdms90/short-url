 ...
 */
class ActorRepository extends AbstractFoundationRepository
{
    /**
     ...
     */
    public function findOneOfAccess($access_id)
    {
        $qb = $this->createQueryBuilder('entity');
        $qb->select('entity')
            ->innerJoin('entity.access', 'access')
            ->addSelect('access');
        $qb->where('entity.deleted = 0');
        $qb->andWhere('access.id = ' . (int)$access_id);
        return $qb->getQuery()
            ->getOneOrNullResult();
    }
